...
log4js.configure({
    appenders: {
        siges_compras: {
        type: "dateFile",
        filename: "../log/siges-compras.log",
        pattern: "yyyy-MM-dd",
        compress: true,
      },
    },
    categories: {
      default: { appenders: ["siges_compras"], level: "debug" },
    },
  });
...
//Inicia Routes
app.use('/compra', routes());
 
//Servidor y puerto
const host = config.HOST;
const port = config.PORT; 
const logger = log4js.getLogger("siges_compras"); 
